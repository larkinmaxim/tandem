      ...
      <div className="flex h-full flex-col overflow-hidden rounded-xl border border-border bg-background [--muted-foreground:var(--text-subtle)]">
        ...
        <div className="flex-shrink-0 p-2 pt-0">
          <button
            ...
            title={collapsed ? t("common:navigation.settings", { defaultValue: "Settings" }) : undefined}
            className={cn(
              "flex items-center w-full text-[13px] transition-colors duration-200 rounded-md gap-2.5 p-3",
